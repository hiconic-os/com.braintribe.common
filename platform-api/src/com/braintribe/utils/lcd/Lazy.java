...
public class Lazy<T> implements Supplier<T> {
	...
	public Lazy(Supplier<T> constructor) {
		this(constructor, null);
	}

	public Lazy(Supplier<T> constructor, Consumer<T> destructor) {
	...
	@Override
	public T get() {
		Box<T> currentIt = itBox;

		if (currentIt == null) {
			boxLock.lock();
			try {
				if (itBox == null)
					itBox = Box.of(constructor.get());
